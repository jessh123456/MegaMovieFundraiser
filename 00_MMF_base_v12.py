...
Summary information regarding profits will be in a separate dataframe so I
...
Calculated total_profit and snack_profit + ticket_profit and added it into the
summary_data list
