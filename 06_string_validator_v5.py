""" Based on 06_string_validator_v3, this program keeps a list of all the
valid orders.
...
snack choices.
This also meant that I had to change the quick reference notation from 1, 2 etc
to (1, (2, (3 etc - to ensure a number wasn't the first and only item in the
string being evaluated.
Also added a maximum of 4 for the number of any particular snack on one order
"""
import re
